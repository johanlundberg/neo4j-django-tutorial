...
After updating your password write `:play movie-graph` in the the query window. Go to the second step of the tutorial and import the graph data.

You can also copy the Cypher statements below and paste it in the query window at the top:
```
